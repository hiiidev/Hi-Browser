...
var migrations = []migration{
	...
	{
		version: 13,
		desc:    "扩展浏览器内核安装与验证元数据",
		stmts: []string{
			`ALTER TABLE browser_cores ADD COLUMN provider TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN source_repository TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN release_tag TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN browser_version TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN chromium_major INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_cores ADD COLUMN asset_id INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_cores ADD COLUMN asset_name TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN platform TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN architecture TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN archive_sha256 TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN executable_path TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN installed_at TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN last_verified_at TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN verification_status TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN installation_status TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN managed_by_app INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_cores ADD COLUMN release_url TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN capabilities_json TEXT NOT NULL DEFAULT ''`,
			`ALTER TABLE browser_cores ADD COLUMN archive_size INTEGER NOT NULL DEFAULT 0`,
